function [pacmat, pacmatZ, freqvec_ph, freqvec_amp] = find_pac_best (sig_pac, Fs, measure, ...
...
if nargin < 13
    dataname = ['NumShf:' num2str(num_shf) ',Alpha:' num2str(alpha)];
end
if nargin < 14
    sig_pac_name = '';
end
...
pacmatZ = (pacmat-squeeze(nanmean(shf_pacmat_final,1)))./squeeze(nanstd(shf_pacmat_final,0,1));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
