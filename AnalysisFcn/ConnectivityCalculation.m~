...
for iseed = seedIndex
    for isearch = searchIndex
        ...
        for isub = 1:numel(allsub)%[1,3,4,6,7,8,9,10]%1:numel(allsub)
            ...
            %% section2-4: calculate Coherence correlation with coordiantes %%
            %%%%%%%%%%%%%%%%%%%%%a%%%
            ...
            %% section2-5: calculate Coherence difference between views %%
            %%%%%%%%%%%%%%%%%%%%%a%%%
            if strcmp(calculate,'COHviews')
                ...
                cfg = [];
                cfg.trials = find(trlData.trialinfo(:,1)==0);
                trlData = ft_selectdata(cfg,trlData);
...
%                                 trlData = ft_selectdata(cfg,trlData);
        ...
        if strcmp(calculate,'COHtrl') | strcmp(calculate,'COHtf')  ...
                | strcmp(calculate,'PSItf') | strcmp(calculate,'GrangerTF') |  strcmp(calculate,'COHviews')
